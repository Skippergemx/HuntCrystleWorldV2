...
export const GameProvider = ({ children, user }) => {
  ...
  const { player, setPlayer, syncPlayer, loadingPlayer, linkWallet, migrateProfile, sessionConflict, addOptimisticUpdate, clearOptimisticUpdates } = usePlayerSync(user, db, appId);
  ...
  const actions = usePlayerActions(
    ...
    functions, setFaucetResult, addOptimisticUpdate, clearOptimisticUpdates
  );
  ...
  const engine = useMemo(() => ({
    ...
    linkWallet, migrateProfile, addOptimisticUpdate, clearOptimisticUpdates,
    network,
    ...
    wallet, linkWallet, migrateProfile, addOptimisticUpdate, clearOptimisticUpdates, network, gvgContext, setGvgContext,
