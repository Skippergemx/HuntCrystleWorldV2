              ...
              {farcasterContext ? (
                ...
                <div className="space-y-3 relative z-10">
                  <button
                    ...
                    className="w-full h-14 bg-white hover:bg-slate-100 text-black rounded-2xl flex items-center justify-between px-5 transition-all transform active:scale-[0.98] border-[3px] border-black shadow-[4px_4px_0_rgba(0,0,0,0.1)] group overflow-hidden relative z-10"
                  >
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs font-black uppercase tracking-tighter italic">Google Auth Login</span>
                    </div>
                    <ChevronRight size={18} />
                  </button>
                  ...
                  <div className="flex items-center gap-2 py-1">
                    ...
                    <span className="text-[7px] font-black text-slate-600 uppercase">OR</span>
                    <div className="flex-1 h-[1px] bg-white/10"></div>
                  </div>
                        ...
                        return (
                          ...
                          >
                            {(() => {
                              if (!connected) {
                                return (
                                  <button onClick={openConnectModal} className="w-full h-14 bg-cyan-600 hover:bg-cyan-500 text-white rounded-2xl flex items-center justify-between px-5 transition-all transform active:scale-[0.98] border-[3px] border-black shadow-[4px_4px_0_rgba(0,0,0,0.2)] group overflow-hidden">
                                     <div className="flex items-center gap-3">
                                        <div className="bg-black p-1.5 rounded-lg border-2 border-white/20">
                                          <Globe size={18} className="text-cyan-400" />
                                        </div>
                                        <span className="text-xs font-black uppercase tracking-tighter italic">Connect Base Wallet</span>
                                     </div>
                                     <ChevronRight size={18} />
                                  </button>
                                );
                              ...
                              return (
                                <button onClick={openAccountModal} className="w-full h-14 bg-slate-800 text-white rounded-2xl flex items-center justify-between px-5 border-[3px] border-black shadow-[4px_4px_0_rgba(0,0,0,0.2)]">
                                  <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-full bg-emerald-500 border-2 border-black flex items-center justify-center font-black text-[8px]">0x</div>
                                    <div className="flex flex-col items-start leading-none">
                                      <span className="text-[8px] font-black uppercase text-emerald-400">Linked: {account.displayName}</span>
                                      <span className="text-[10px] font-black italic">{account.displayBalance ? `${account.displayBalance}` : 'READY'}</span>
                                    </div>
                                  </div>
