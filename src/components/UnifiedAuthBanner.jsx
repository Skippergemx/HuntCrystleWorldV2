        ...
        {address ? (
          <div className="flex items-center gap-2 px-3 py-1 bg-emerald-500/10 border border-emerald-500/40 rounded-full shadow-[0_0_10px_rgba(16,185,129,0.1)]">
            ...
            <div className="flex items-center gap-1.5">
               <span className="text-[8px] font-black text-emerald-400 uppercase tracking-widest italic hidden sm:inline">Wallet_Synced</span>
          ...
          user && (
            ...
            >
              ...
              {isFarcaster ? "Sync Rewards Wallet" : "Establish Link"}
            </button>
          )
        )}
      </div>
